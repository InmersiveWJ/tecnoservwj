const productosTecnoServ = [
  {
    ...
    descripcion: "Laptop gaming de 16 pulgadas recomendada para estudios, trabajo, multitarea, edición ligera, programación, diseño y juegos en configuración media.",
    especificaciones: {
    ...
    incluye: ["Laptop Asus Gaming V16", "Cargador original", "Windows 11 Home", "Revisión técnica antes de entrega", "Asesoría básica de uso y cuidado", "Configuración inicial según solicitud"],
    metodosPago: ["Yape", "Plin", "Transferencia bancaria", "Efectivo contra entrega", "Separación previa coordinación"],
    resenas: [{ autor: "TecnoServWJ", comentario: "Equipo recomendado para usuarios que desean una laptop moderna con gráfica dedicada." }]
  },
  {
    id: "lenovo-ideapad-ryzen5",
    categoria: "laptops",
    marca: "Lenovo",
    ...
    descripcion: "Laptop ideal para estudios, oficina, navegación, clases virtuales y tareas diarias.",
    especificaciones: { Procesador: "AMD Ryzen 5", RAM: "8 GB", Almacenamiento: "SSD 256 GB", Pantalla: "15.6 pulgadas", Sistema: "Windows 11", Estado: "Usado en buen estado" },
  ...
  },
  {
    ...
    especificaciones: { Procesador: "Intel Core i5", RAM: "8 GB", Almacenamiento: "SSD 240 GB", Pantalla: "14 pulgadas", Sistema: "Windows 10/11 según compatibilidad", Estado: "Usado operativo" },
    incluye: ["Cargador", "Configuración inicial", "Prueba de funcionamiento"],
    metodosPago: ["Yape", "Plin", "Transferencia bancaria", "Efectivo"],
    resenas: []
  },
  {
    id: "laptop-gamer-bajo-pedido",
    categoria: "laptops",
    marca: "Varias marcas",
    ...
    descripcion: "Consulta por laptops gamer según presupuesto, uso requerido y disponibilidad.",
    especificaciones: { Procesador: "Según disponibilidad", RAM: "Según configuración", Almacenamiento: "SSD recomendado", Pantalla: "Según modelo", Gráficos: "Dedicados según presupuesto", Estado: "Nuevo o usado según consulta" },
